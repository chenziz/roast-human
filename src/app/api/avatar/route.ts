...
export async function GET(request: NextRequest) {
  ...
  const prompts: Record<string, string> = {
    speedrunner: 'running with speed lines',
    arsonist: 'holding a torch with flames',
    yolo: 'jumping with arms raised',
    therapist: 'sitting with a notebook',
    outsourcer: 'sleeping while a robot works',
    npc: 'standing still with exclamation mark',
    yapper: 'talking with speech bubbles',
    cheerleader: 'cheering with a flag',
    maincharacter: 'posing on a stage with spotlight',
    doomscroller: 'sitting with a glowing phone',
    lurker: 'peeking from behind a wall',
    ghost: 'fading and transparent',
    overthinker: 'surrounded by question marks',
    rewriter: 'holding pencil with crumpled paper',
    hallucinationhunter: 'holding magnifying glass',
    dreamer: 'looking up at stars',
    perfectionist: 'polishing a diamond',
    phoenix: 'standing in fire',
  }
