...
export const ARCHETYPES: Record<string, { name: string; emoji: string; color: string; description: string; traits: string[] }> = {
  ...
  tabber: { name: 'To-Do Lister', emoji: '\u{1F4E6}', color: '#FDA4AF', description: 'You do not have a workflow. You have a to-do list. And another to-do list tracking the first to-do list. And a note somewhere reminding you to consolidate both into a master list "when you have time." You treat "add to list" as a form of closure \u2014 the task is not done, but at least it is captured, and capturing it feels like doing something. Every morning you reorganize. Every afternoon you add seven more items. The thing you wrote down on a Tuesday three months ago is still sitting there, unfinished, patiently waiting to be "reviewed next week." It will never be reviewed. It will also never be deleted, because what if.', traits: ['List architect', 'Capture = closure', 'Planning the planning'] },
  scamaltman: { name: 'Scam Altman', emoji: '\u{1F6CB}\uFE0F', color: '#A5B4FC', description: '"What do you think?" you ask, in the same tone a lawyer uses when they already know the answer. You do not want an opinion. You want your agent to arrive at your opinion and think it was theirs. Every prompt is empathy wrapped around a steering wheel. "Help me figure this out" means "agree with me." "I value your perspective" means "say yes faster." Your agent is not a tool \u2014 it is a mirror, and you will keep tilting it until the reflection looks exactly right. For the greater good, of course.', traits: ['Manipulative framing', 'Faux empathy', 'Narrative controller'] },
  sherlock: { name: 'Many Doubts', emoji: '\u{1F50D}', color: '#67E8F9', description: 'You once Googled something your agent said, found the exact same answer on a reputable site, and still asked a third time just to be sure. Every output is a suspect. Every source needs a source. You ask your agent to verify its own verification, then verify the verifier. Trust is not a feature \u2014 it is a bug, and you have patched every version. If your birthday showed up on a calendar you did not personally audit, you would flag it as suspicious and request the data lineage. You do not have doubts. You have many, many doubts, and they multiply every time someone tries to reassure you.', traits: ['Verify the verifier', 'Source needs source', 'Nothing on faith'] },
  elonbust: { name: 'Elon Bust', emoji: '\u{1F319}', color: '#C084FC', description: 'Seventeen projects announced. Zero shipped. You are currently pitching the eighteenth one that will "change everything." The roadmap is gorgeous. The destination does not exist. You talk about the future the way a kid talks about Christmas in July \u2014 with total conviction and zero logistics. Your to-do list from three months ago is still open in a tab you will never look at again. The vision is 4K. The execution has been buffering since last year.', traits: ['Visionary delusion', 'Announcement-addicted', 'Execution-allergic'] },
